    ...
    <section className="pb-[148px] lg:pb-[192px]">
      <Container>
        <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between mb-6 lg:mb-12">
          <div>
            <h2 className="mb-3 lg:mb-4 text-[36px] lg:text-[64px] font-manrope font-light uppercase leading-[120%] text-white">
              {t("title")}
            </h2>
            <p className="md:max-w-[300px] lg:max-w-[647px] font-manrope text-[16px] font-light leading-[120%] text-white lg:text-[20px] uppercase">
              {t("descriptionLeft")}
            </p>
          </div>
          <div className="flex gap-5 md:max-w-[300px] lg:max-w-[392px]">
