    ...
    <section className="pb-[148px] lg:pb-[192px]">
      <Container>
        <div className="p-5 rounded-[12px] shadow-[inset_3px_-1px_9px_-1px_rgba(255,255,255,0.12)] bg-white/3 backdrop-blur-[24px]">
          <div className="flex flex-col gap-3 md:justify-between mb-6 lg:mb-8">
          ...
          <div className="flex flex-col gap-6 md:justify-between mb-6 lg:mb-5">
            <div className="flex gap-3 items-center w-[185px] justify-between">
              <p className="font-montserrat text-[12px] lg:text-[14px] leading-[120%] text-white font-light">
                {t("fromLabel")}
              </p>
              <div>
                <p className="font-manrope text-[32px] lg:text-[60px] leading-[120%] text-white font-light uppercase">
                  {t("fromPrice")}
                </p>
                <p className="font-manrope text-[32px] lg:text-[60px] leading-[120%] text-[#818181] font-light uppercase">
                  {t("fromEur")}
                </p>
              </div>
            </div>
            <div className="flex gap-3 items-center w-[197px] justify-between">
              <p className="font-montserrat text-[12px] lg:text-[14px] leading-[120%] text-white font-light">
                {t("toLabel")}
              </p>
              <div>
          ...
          >
            {listItems.map((item) => (
              <li
                key={item}
                className="flex items-center gap-5 px-4 py-3 lg:px-5 lg:py-4 rounded-full bg-black"
              >
